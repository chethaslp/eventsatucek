...
export default function Loading({msg}:{msg: string}) {
    return (
        <div className="flex gap-3  h-screen w-screen flex-col z-50 dark:bg-[#121212]">
            <div className="flex justify-center flex-col items-center h-full w-full animate-pulse transition-all drop-shadow-xl">
                <Logo className={"text-4xl md:text-6xl"} loading={true}/>
                <p className="text-[15px]">An initiative by IEEE SB UCEK</p>
            </div> 
