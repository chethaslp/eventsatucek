...
function Bannner({ bannerEvent, date }: { bannerEvent: Array<string> , date: any}) {
  return (
    <div
    ...
    >
      ...
      <div className="absolute inset-0 bg-black bg-opacity-10 backdrop-blur-sm bg-gradient-to-t from-black to-transparent flex items-center justify-center"></div>

      {/* Content */}
      <div className="relative z-10 flex  flex-col md:flex-row items-center p-20 md:gap-24  h-full">
        <div>
          <Image
            width={350}
            height={350}
            ...
            onClick={() => (window.location.href = "/e/" + "event")}
