    ...
    <div class="container" style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #fff; border-radius: 8px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);">
     ...
     <div class="content" style="padding: 20px;">
        ...
        {{#ifEquals customText ""}}
         ...
         <center>
            <a href="https://events.uck.ac.in/e/{{eventID}}" class="btn" style="background-color: #121212; color: #ffffff; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block; margin: 20px 0;">Get my Ticket</a>
          </center>
        </p>
        <p>
          Cheers!<br>
