const template =  `<html lang="en">
  ...
  <body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0;">
    <div class="container" style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #fff; border-radius: 8px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);">
       <div class="header" style="background: linear-gradient(45deg, #121212, #2c2c2c); background-color: #000000; color: white; background-repeat: no-repeat; background-size: cover; background-image: url(https://events.ieeesbucek.in/img/bg-mail.png); text-align: center; padding: 30px 0; padding-bottom: 60px; margin-bottom: 0; border-radius: 8px 8px 0 0;">
